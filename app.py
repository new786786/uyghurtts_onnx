...
# 2. RVC变声配置
RVC_MODEL_FILE = "clone_onnx\\1.onnx"  # RVC模型路径
RVC_INDEX_FILE = "clone_onnx\\added_IVF1258_Flat_nprobe_1_mi-test_v2.index"  # RVC索引文件（无则留空）
RVC_DEVICE = "cpu"  # 有NVIDIA显卡改为"cuda:0"
# RVC参数
RVC_PITCH = -5  # 音高调整（0不变，正数升高，负数降低）
RVC_INDEX_RATE = 0.5  # 音色相似度（0.3-0.9）
